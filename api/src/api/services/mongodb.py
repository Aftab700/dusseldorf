...
class MongoDBService:
    ...
    async def connect(self):
        ...
        self.client = AsyncIOMotorClient(
            self.settings.MONGODB_URL, **self.settings.get_mongodb_options()
        )
    ...
    async def create_indexes(self):
        ...
        try:
            ...
            # Automatic cleanup after expires_at
