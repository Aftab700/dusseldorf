                ...
                <DialogBody>
                    ...
                    <DialogContent className="stack vstack-gap">
                        ...
                        <Field
                            ...
                            validationState={
                                Number.isNaN(numZones) || numZones > 100
                                    ? "error"
                                    : "none"
                            }
                        >
                        ...
                        {errorMsg && (
                            <MessageBar intent="error">
                                Insufficient permissions to add zones on domain.
                            </MessageBar>
                        )}

                        {completeMsg && (
                            <MessageBar intent="success">
                                Zones successfully added.
                            </MessageBar>
                        )}
                    </DialogContent>
