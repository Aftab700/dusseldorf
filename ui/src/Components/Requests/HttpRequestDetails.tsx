                ...
                {!req.body && req.body_b64 && showFullRawReq ? (
                    <div className="stack">
                        <div style={{ margin: 5, marginTop: 10 }}>
                            Because the body of this request contains binary
                            content, it cannot be shown inside Dusseldorf. You
                            can download the body content or copy it to your
                            clipboard as base64.
                        </div>
                            ...
                            <Dialog>
                                ...
                                <DialogSurface style={{ width: 400 }}>
                                    <DialogBody>
                                        ...
                                        <DialogContent>
                                            There may be sensitive content in
                                            this request, please handle with
                                            care.
                                        </DialogContent>
                                        <DialogActions>
                                            <DialogTrigger
