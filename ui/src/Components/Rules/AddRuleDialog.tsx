...
export const AddRuleDialog = ({ zone, onSave }: AddRuleDialogProps) => {
    ...
    const [showMsg, setShowMsg] = useState<"error" | "success" | "info">(
        "info",
    );
                ...
                <DialogBody>
                    ...
                    <DialogContent>
                        ...
                        >
                            ...
                            <Field
                                ...
                                validationState={
                                    isValidPriority(priority) ? "none" : "error"
                                }
                            >
                                <Input
                                    value={
                        ...
                        <MessageBar intent={showMsg} style={{ marginTop: 20 }}>
                            {showMsg == "info" ? (
                                <Text>
                                    After a new zone is created, you can add
                                    various components to it. This allows you to
                                    filter requests based on certain criteria or
                    ...
                    <DialogActions>
                        <Button
                            ...
                            icon={<SaveRegular />}
                            disabled={
                                !isValidPriority(priority) || showMsg != "info"
                            }
                            onClick={() => {
