...
export const ResultHeaderRuleComponent = ({
    onSave,
    onDismiss,
}: ResultHeaderRuleComponentProps): JSX.Element => {
    ...
    return (
        <div className="stack hstack-center">
            <div className={"stack hstack-gap"} style={{ alignItems: "start" }}>
                <Field
                    label="Header Name"
                    validationMessage={
                        header.length > 0 ? undefined : "Cannot be empty"
                    }
                >
                    <Combobox
