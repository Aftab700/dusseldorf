        ...
        <div>
            ...
            <div className="stack vstack-gap">
                ...
                <div className="stack hstack">
                        ...
                        <Input
                            ...
                            onChange={(_, data) => {
                                ...
                                if (isNaN(newPriority)) {
                                    ...
                                    setPriority(
                                        Number(
                                            newPriority.toString().slice(0, 3),
                                        ),
                                    );
                                }
                                setShowPriorityError(false);
                    ...
                    <Tooltip content="Save rule priority" relationship="label">
                        <Button
                            appearance="subtle"
                            icon={<SaveRegular />}
                            disabled={
            ...
            >
                <DialogTrigger disableButtonEnhancement>
                    <Button icon={<DeleteRegular />} style={{ width: 130 }}>
                        Delete rule
                    </Button>
                </DialogTrigger>
                                ...
                                onClick={() => {
                                    if (rule) {
                                        DusseldorfAPI.DeleteRule(rule)
                                            .then(() => {
                                                Logger.Info(
                                                    `rule ${rule.ruleid} for ${rule.zone} deleted`,
                                                );
