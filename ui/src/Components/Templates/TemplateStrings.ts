export const JSAlertDomain = `id: jsalertdom
...
export const CORSOptionsCall = `id: cors
...
export const XssExfilCall = `id: exfiljs
...
export const KeyVaultTokenExfil = `id: psimdskeyvault
...
export const XXEOOBCall = `id: xxeoob
title: XXE Call
...
export const DNSSetToLocalhost = `id: localhost
