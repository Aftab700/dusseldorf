            ...
            >
                ...
                <NavDrawerBody>
                    ...
                    <NavCategory value="templates">
                        <NavCategoryItem
                            icon={<WindowEditRegular fontSize={20} />}
                        >
                            Templates
                        </NavCategoryItem>
                        <NavSubItemGroup>
                            <NavSubItem value="jsalertdom">
                                XSS alert(domain)
                            </NavSubItem>
                            <NavSubItem value="cors">
                                CORS options call
                            </NavSubItem>
                            <NavSubItem value="exfiljs">
                                Exfil DOM using JS
                            </NavSubItem>
                            <NavSubItem value="psimdskeyvault">
                                Powershell IMDS AKV Exfil
                            </NavSubItem>
                            <NavSubItem value="xxeoob">
                                XXE Out of band exfil
                            </NavSubItem>
                            <NavSubItem value="localhost">
                    ...
                    <NavCategory value="zones">
                        <NavCategoryItem
                            icon={<TargetEditRegular fontSize={20} />}
                        >
                            Zones
                        </NavCategoryItem>
