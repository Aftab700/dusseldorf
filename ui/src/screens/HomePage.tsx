...
export const HomePage = () => {
    ...
    return (
        ...
        >
            ...
            >
                <div className="stack vstack-gap">
                    ...
                    {recentZones.length > 0 ? (
                        <Text>
                            Create a new DNS zone, or open a recent one to pick
            ...
            <div className="stack vstack-gap">
                <Text>
                    Dusseldorf is a platform for analyzing out-of-band network
                    requests to detect security vulnerabilities at scale. It is
                    intented to help with application security research. If you
                    are unsure if you should be using this software, please
                    contact your security team or contact us on:{" "}
                ...
                <Text>
                    This platform is used to automatically detcet and dissect
                    network traffic and iteratively manipulate its responses
                    with custom payloads to ease further analysis and
                    exploitation. This process helps in exploring, researching
                    and exploiting cloud vulnerabilities such as{" "}
                ...
                <Text>
                    ...
                    subdomains) to determine the routing of network requests.
                    This way, only you can see what is sent to your zones, or
                    you can setup strong{" "}
                    <abbr title="Role Based Access Control">RBAC</abbr> rules to
                    provide granular access to other to collaborate.
                </Text>

                <Text>
                    For more information and information on how to get started,
                    go to{" "}
