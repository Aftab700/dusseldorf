...
export const TemplatesScreen = () => {
    ...
    return (
        <div
            className="stack stack-screen vstack-gap"
            style={{ marginLeft: 20 }}
        >
            <Title2>Templates</Title2>

            <Text>
                Dusseldorf comes with several pre-installed internal and
                community-driven security payloads to aid in making customized
                responses. These templates can be used to craft a better
                response and allow an operator to chain several attack payloads,
                providing a better exploitation chain.
            </Text>

            <MessageBar>
                Templates are still experimental and may not work as expected.
            </MessageBar>
